<%-- 
    Document   : index
    Created on : 14-Jun-2025, 21:08:39
    Author     : muham
--%>
...
-->
                ...
                <div class="col-12">
                    <nav class="main-nav">
                       ...
                       <a href="index.html" class="logo">
                        <img src="assets/images/trift.png" alt="Thryft Logo" >
                        </a>
    ...
    <div class="main-banner" id="top" style="margin-top: 120px;">
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="assets/images/wPic.jpg">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="assets/images/mPic.jpg">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="men-item-carousel">
                        ...
                        <%
                            ArrayList<Product> menProducts = (ArrayList<Product>) request.getAttribute("menProducts");
                            if (menProducts != null && !menProducts.isEmpty()) {
                ...
                <div class="col-lg-12">
                    <div class="women-item-carousel">
                        <div class="owl-women-item owl-carousel">
                            <%
                                ArrayList<Product> womenProducts = (ArrayList<Product>) request.getAttribute("womenProducts");
                                if (womenProducts != null && !womenProducts.isEmpty()) {
                                    for (Product p : womenProducts) {
                            %>
                                        <!-- YOUR HTML RENDERING LOGIC -->
                                        <div class="item">
                                            <div class="thumb">
                                                <img src="<%= p.getImagePath() %>" alt="" class="thumb">
                                            </div>
